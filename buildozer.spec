...
# (str) Package name
package.name = retrobox

# (str) Package domain (needed for android/ios packaging)
package.domain = com.mayoonexe
...
author = Simone Signorile <simonesignorile4@gmail.com>
...
# Setting this to false will pass --ignore-setup-py, true will use --use-setup-py
